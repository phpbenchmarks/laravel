...
$files = [
    ...
    "$sourceCodePath/app/Exceptions/Handler.php",
    ...
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Contracts/Container/BindingResolutionException.php",
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Contracts/Container/Container.php",
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Contracts/Debug/ExceptionHandler.php",
    ...
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Foundation/Exceptions/Handler.php",
    ...
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Log/Events/MessageLogged.php",
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Log/LogManager.php",
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Log/LogServiceProvider.php",
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Log/Logger.php",
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Log/ParsesLogConfiguration.php",
    ...
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Support/Facades/Auth.php",
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Support/Facades/Facade.php",
    "$sourceCodePath/vendor/laravel/framework/src/Illuminate/Support/Facades/View.php",
    ...
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/DateTimeImmutable.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Formatter/FormatterInterface.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Formatter/LineFormatter.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Formatter/NormalizerFormatter.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Handler/AbstractHandler.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Handler/AbstractProcessingHandler.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Handler/FormattableHandlerInterface.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Handler/FormattableHandlerTrait.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Handler/Handler.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Handler/HandlerInterface.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Handler/ProcessableHandlerInterface.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Handler/ProcessableHandlerTrait.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Handler/StreamHandler.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Logger.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/ResettableInterface.php",
    "$sourceCodePath/vendor/monolog/monolog/src/Monolog/Utils.php",
    ...
    "$sourceCodePath/vendor/psr/container/src/ContainerExceptionInterface.php",
    "$sourceCodePath/vendor/psr/container/src/ContainerInterface.php",
    "$sourceCodePath/vendor/psr/log/Psr/Log/LoggerInterface.php",
    ...
    "$sourceCodePath/vendor/symfony/debug/Exception/FlattenException.php",
    "$sourceCodePath/vendor/symfony/debug/ExceptionHandler.php",
    ...
    "$sourceCodePath/vendor/symfony/http-kernel/Exception/HttpException.php",
    "$sourceCodePath/vendor/symfony/http-kernel/Exception/HttpExceptionInterface.php",
    "$sourceCodePath/vendor/symfony/http-kernel/Exception/NotFoundHttpException.php",
